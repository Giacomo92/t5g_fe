...
import './AthleteSingleGameLeft.css'

const AthleteSingleGameLeft = ({ athlete }) => {
  ...
  athleteName = (
    <p className='AthleteSingleGameNameLeft'>
  ...
  if (athlete.sport_name === 'f1' || athlete.sport_name === 'motogp') {
    athleteEvent = (
      <p className='AthleteSingleGameEventLeft'>@ {athlete.next_event.name}</p>
    )
  } else {
    athleteEvent = (
      <p className='AthleteSingleGameEventLeft'>
  ...
  return (
    <div className='AthleteSingleGameLeft'>
      ...
      <div className='AthleteSingleGameResultOrTimeLeft'>
...
export default AthleteSingleGameLeft
